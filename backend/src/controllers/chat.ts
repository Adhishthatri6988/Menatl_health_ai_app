  ...
  try {
    ...
    const event: InngestEvent = {
      ...
      data: {
        ...
        memory: { userProfile: { emotionalState: [], riskLevel: 0, preferences: {} }, sessionContext: { conversationThemes: [], currentTechnique: null } },
        goals: [],
    ...
    const responsePrompt = `Based on the following context, generate a therapeutic response...`;
    ...
    session.messages.push({
      ...
      content: response,
      timestamp: new Date(),
      metadata: { analysis, progress: { emotionalState: analysis.emotionalState, riskLevel: analysis.riskLevel } },
    });
    ...
    res.json({
      ...
      message: response,
      analysis,
      metadata: { progress: { emotionalState: analysis.emotionalState, riskLevel: analysis.riskLevel } },
    });
  } catch (error) {
